...
private:
    ...
    asdx::StructuredBuffer      m_TangentBuffer;
    ...
    asdx::ComputeTarget         m_DebugWriteIndexBuffer;

    asdx::RefPtr<ID3D12RootSignature>   m_RootSigMS;
    asdx::PipelineState                 m_PipelineStateMS;
    asdx::PipelineState                 m_WireframeStateMS;
    ...
    asdx::VertexBuffer                  m_PositionVB;
    asdx::VertexBuffer                  m_NormalVB;
    asdx::VertexBuffer                  m_TexCoordVB;
    asdx::IndexBuffer                   m_IndexIB;
